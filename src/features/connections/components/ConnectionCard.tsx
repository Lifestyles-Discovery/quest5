...
interface ConnectionCardProps {
  ...
  onToggleVisibility: (connection: Connection) => void;
}
...
const TYPE_ICONS: Record<string, string> = {
  ...
  Other: 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z',
};
...
export function ConnectionCard({
  ...
  const iconPath = TYPE_ICONS[connection.type] || TYPE_ICONS.Other;
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 space-y-1">
            {connection.email && (
              <a
                ...
                className="flex items-center gap-2 text-sm text-gray-500 hover:text-brand-500 dark:text-gray-400"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
          ...
          <div className="mt-4 flex gap-2">
            ...
            >
              {connection.deleted ? 'Restore' : 'Hide'}
            </Button>
          </div>
        </div>
      </div>
